...
<template>
  <UCarousel
    ...
    :ui="{
      item: 'basis-full lg:basis-1/5 mr-8 rounded-lg',
    ...
    arrows
    class="w-full mx-auto rounded-lg mb-12"
  >
    <div class="relative h-46">
      <img
        :src="item.storefrontphoto"
        class="w-full object-cover h-64 rounded-lg"
        draggable="false"
      />
      <div
        class="absolute h-16 w-full bottom-0 backdrop-blur-lg rounded-t-lg px-4"
      >
